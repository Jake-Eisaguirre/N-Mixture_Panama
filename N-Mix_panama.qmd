...
detection_results_season1_ddn <- setNames(detection_results, paste(c(spec_list), "season1_ddn", sep = "_"))

lambda_results_season1_ddn <- setNames(lambda_results, paste(c(spec_list), "season1_ddn", sep = "_"))
...
detection_results_season1_dddn <- setNames(detection_results, paste(c(spec_list), "season1_dddn", sep = "_"))

lambda_results_season1_dddn <- setNames(lambda_results, paste(c(spec_list), "season1_dddn", sep = "_"))
